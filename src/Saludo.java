...
public class Saludo
{
	...
	public static void main(String[] args)
	{
		...
		String horaOriginal; 
		String[] horaCortada; 
		do { System.out.println("Dame la hora en formato HH:MM -->");
		horaOriginal = teclado.nextLine();
		}
		while(horaOriginal.length()!=5);
		teclado.close(); // Separamos la hora de los minutos 
		...
		{ 
			System.out.println("Buenas tardes"); } else { System.out.println("Buenas noches"); 
			}
	}
}
